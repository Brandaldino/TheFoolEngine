...
namespace TheFoolEngine
{
	...
	private:
		...
		void ProcessFBXFile(aiMaterial* mat, const aiScene* scene, Ref<MaterialBuilder>& builder);
	private:
		Ref<Texture2D> CreateSolidColorTexture(aiMaterial* mat, aiTextureType aiType);
	private:
